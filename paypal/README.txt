BRAINTREE HOSTED FIELDS AND CHECKOUT WITH PAYPAL DEMO
...
4) Open the website in the browser and access it as: http://my_domain/php_code_folder_name/index.php
   ...
   The php_code_folder_name is the name of the folder under which the downloaded code resides ('BraintreeHFPPDemo' folder in case you have not changed the default name).
